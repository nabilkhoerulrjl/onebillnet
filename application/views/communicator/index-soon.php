...
<script>
    ...
    function getDataTo(TypeTarget){

        var base_url = "<?php echo base_url(); ?>";
        var mediaSelect = $('#mediaSelect').val();
        var typeTarget = TypeTarget;
        var requestData = {
            TypeTarget: typeTarget,
            Media: mediaSelect,
        };
        $.ajax({
            url: base_url + 'BroadcastController/getToData',
            dataType: 'json',
            method: 'POST',
            data: mediaSelect,
            beforeSend: function() {
