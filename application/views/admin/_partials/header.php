            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right notification">
                    ...
                    <ul class="noti-body">
                        ...
                        <li class="notification">
                            <div class="media">
                                <img class="img-radius" src="<?= base_url() ?>public/images/user/avatar-2.jpg" alt="Generic placeholder image">
                                <div class="media-body">
        ...
        <li>
            <div class="dropdown drp-user">
                ...
                <div class="dropdown-menu dropdown-menu-right profile-notification">
                    <div class="pro-head"> 
                        <img src="<?= base_url()?> /File/getFile/<?= $this->session->userdata('picture') ?>" class="img-radius" alt="User-Profile-Image">
