<div class="wrapper wrapper-content">
    <div class="row mb-3">
        <!-- Dashboard JS -->
            <?php $this->load->view("widgets/cpuUsage.php") ?>
        <!-- End of Dashboard JS -->
        <!-- Dashboard JS -->
            <?php $this->load->view("widgets/tempCpu.php") ?>
        <!-- End of Dashboard JS -->
        <!-- Dashboard JS -->
    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="ibox">
                <div class="ibox-content">
                    <h5 class="m-b-md">Server status ISP</h5>
                    <h2 class="text-navy">
        ...
        <div class="col-lg-4">
            <div class="ibox">
                <div class="ibox-content">
                    <h5 class="m-b-md">Server status Mikrotik</h5>
                    <h2 class="text-navy">
                        <i class="fa fa-play fa-rotate-270"></i> Up
                    </h2>
                    <small>Last down 42 days ago</small>
