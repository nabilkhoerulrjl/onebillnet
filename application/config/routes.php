...
$route['reference'] = 'referencecontroller';
$route['customergroup'] = 'customergroupcontroller';
$route['File'] = 'file';
$route['template'] = 'templatecontroller';
$route['webhook'] = 'webhook/receiveMessageStatus';
// $route['file/(:num)'] = 'file_controller/getFile/$1';
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;
